...
(cl:defmethod cl:initialize-instance :after ((m <GuiMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GuiMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vision-msg:<GuiMsg> is deprecated: use vision-msg:GuiMsg instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <GuiMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision-msg:stamp-val is deprecated.  Use vision-msg:stamp instead.")
  (stamp m))
...
(cl:defmethod machine-val ((m <GuiMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision-msg:machine-val is deprecated.  Use vision-msg:machine instead.")
  (machine m))

(cl:ensure-generic-function 'm_state-val :lambda-list '(m))
(cl:defmethod m_state-val ((m <GuiMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision-msg:m_state-val is deprecated.  Use vision-msg:m_state instead.")
  (m_state m))

(cl:ensure-generic-function 't_course-val :lambda-list '(m))
(cl:defmethod t_course-val ((m <GuiMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision-msg:t_course-val is deprecated.  Use vision-msg:t_course instead.")
  (t_course m))
