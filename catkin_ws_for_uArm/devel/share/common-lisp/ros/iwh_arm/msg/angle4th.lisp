...
(cl:defmethod cl:initialize-instance :after ((m <angle4th>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'angle4th)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iwh_arm-msg:<angle4th> is deprecated: use iwh_arm-msg:angle4th instead.")))

(cl:ensure-generic-function 'angle4th-val :lambda-list '(m))
(cl:defmethod angle4th-val ((m <angle4th>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:angle4th-val is deprecated.  Use iwh_arm-msg:angle4th instead.")
  (angle4th m))
