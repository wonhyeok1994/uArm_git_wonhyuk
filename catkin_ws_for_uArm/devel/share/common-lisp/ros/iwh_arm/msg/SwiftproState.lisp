...
(cl:defmethod cl:initialize-instance :after ((m <SwiftproState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SwiftproState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name iwh_arm-msg:<SwiftproState> is deprecated: use iwh_arm-msg:SwiftproState instead.")))

(cl:ensure-generic-function 'motor_angle1-val :lambda-list '(m))
(cl:defmethod motor_angle1-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:motor_angle1-val is deprecated.  Use iwh_arm-msg:motor_angle1 instead.")
  (motor_angle1 m))

(cl:ensure-generic-function 'motor_angle2-val :lambda-list '(m))
(cl:defmethod motor_angle2-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:motor_angle2-val is deprecated.  Use iwh_arm-msg:motor_angle2 instead.")
  (motor_angle2 m))

(cl:ensure-generic-function 'motor_angle3-val :lambda-list '(m))
(cl:defmethod motor_angle3-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:motor_angle3-val is deprecated.  Use iwh_arm-msg:motor_angle3 instead.")
  (motor_angle3 m))

(cl:ensure-generic-function 'motor_angle4-val :lambda-list '(m))
(cl:defmethod motor_angle4-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:motor_angle4-val is deprecated.  Use iwh_arm-msg:motor_angle4 instead.")
  (motor_angle4 m))
...
(cl:defmethod pump-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:pump-val is deprecated.  Use iwh_arm-msg:pump instead.")
  (pump m))

(cl:ensure-generic-function 'swiftpro_status-val :lambda-list '(m))
(cl:defmethod swiftpro_status-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:swiftpro_status-val is deprecated.  Use iwh_arm-msg:swiftpro_status instead.")
  (swiftpro_status m))

(cl:ensure-generic-function 'gripper-val :lambda-list '(m))
(cl:defmethod gripper-val ((m <SwiftproState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iwh_arm-msg:gripper-val is deprecated.  Use iwh_arm-msg:gripper instead.")
  (gripper m))
