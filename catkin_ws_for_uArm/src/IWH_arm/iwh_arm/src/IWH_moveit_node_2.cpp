...
int main(int argc, char **argv)
{
  printf("moveit_node.cpp START");
	...
	ros::init(argc, argv, "IWH_moveit_node_2");
	ros::NodeHandle n;
	
	ros::Subscriber sub1 = n.subscribe("iwh_ctl_topic_2", 1, iwh_ctl_topic_callback);
		
	ros::Publisher 	pub = n.advertise<swiftpro::position>("position_write_topic_2", 1);
